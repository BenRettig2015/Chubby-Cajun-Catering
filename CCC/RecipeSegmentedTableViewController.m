...
#import "RecipeSegmentedTableViewController.h"
...
@interface RecipeSegmentedTableViewController ()<UISearchBarDelegate>
...
@implementation RecipeSegmentedTableViewController
...
- (void)searchBar:(UISearchBar *)searchBar textDidChange:(NSString *)searchText
{
    ...
    {
        NSPredicate *resultPredicate = [NSPredicate predicateWithFormat:@"name contains[c] %@", self.searchBar.text];
        recipes = [recipes filteredArrayUsingPredicate:resultPredicate];
    }
